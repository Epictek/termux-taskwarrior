...
/* Command for C compiler:
   clang -c  -w  -I/data/data/com.termux/files/usr/lib/nim/lib -o /data/data/com.termux/files/home/termux-taskwarrior/nimcache/stdlib_strutils.o /data/data/com.termux/files/home/termux-taskwarrior/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_22, "len(a) == L string modified while iterating over it", 51);
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_23, "", 0);
...
{	result = (NI)0;
	...
	m = (((a ? a->Sup.len : 0) <= (b ? b->Sup.len : 0)) ? (a ? a->Sup.len : 0) : (b ? b->Sup.len : 0));
	{
		...
		while (1) {
			...
			TM_JGc9b9bh2D3nTdUR7TGyq8aA_19 = subInt(((NU8)(T3_)), ((NU8)(T4_)));
			...
			i = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_20);
		} LA2: ;
	}
	nimln_(414, "strutils.nim");
	TM_JGc9b9bh2D3nTdUR7TGyq8aA_21 = subInt((a ? a->Sup.len : 0), (b ? b->Sup.len : 0));
	result = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_21);
	}BeforeRet_: ;
	popFrame();
	return result;
}
		...
		L = (s ? s->Sup.len : 0);
		{
			while (1) {
				...
				i += ((NI) 1);
				{
					...
					failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_22));
				}
				LA10_: ;
			} LA3: ;
		}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, nsuReplaceStr)(NimStringDesc* s, NimStringDesc* sub, NimStringDesc* by) {
	...
	result = (NimStringDesc*)0;
	result = copyString(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_23));
...
N_LIB_PRIVATE N_NIMCALL(tySequence_sM4lkSb7zS6F7OVMvW9cffQ*, nsuSplitWhitespace)(NimStringDesc* s, NI maxsplit) {
